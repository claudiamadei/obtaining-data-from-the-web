...
```zsh
cd obtaining-data-from-the-web
touch .env
```
...
Now that you have your API keys setup, load the packages we'll use in this tutorial. Most of the heavy listing will be done by the YouTube module of the course package, `icsspy`. Uses single packages in this version:
